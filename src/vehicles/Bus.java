...
public class Bus extends LandVehicle implements FuelConsumable, PassengerCarrier, CargoCarrier, Maintainable {
    ...
    public Bus(String stringID, String model, double maxSpeed, double currentMileage, int numWheels,
    ...
    public double consumeFuel(double distance) throws InsufficientFuelException {
        ...
        if(fuelLevel < fuelConsumed){
            throw new InsufficientFuelException("The bus does not have enough fuel to travel.\n");
        }
        return fuelConsumed;
    }
    ...
    public void loadCargo(double weight) throws OverloadException {
        ...
        if(weight > cargoSpace){
            throw new OverloadException("The bus does not have enough space for given cargo.\n");
        }
        currentCargo += weight;
    ...
    public void unloadCargo(double weight) throws InvalidOperationException {
        if(weight > currentCargo){
            throw new InvalidOperationException("Not enough cargo in bus to unload.\n");
        }
    };
    ...
    public void disembarkPassengers(int count) throws InvalidOperationException {
        if(count > currentPassengers){
            throw new InvalidOperationException("Not enough people in the bus to disembark.\n");
        }
    };
